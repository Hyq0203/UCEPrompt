...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.IVLP.USE_FLEXIBLE_IVLP = False
    cfg.TRAINER.IVLP.FLEX_PROMPT_DEPTH_VISION = 8
    cfg.TRAINER.IVLP.FLEX_PROMPT_DEPTH_TEXT = 8
    cfg.TRAINER.IVLP.PRIOR_FUSION_LAYER_TEXT = 5
    cfg.TRAINER.IVLP.PRIOR_FUSION_LAYER_VISION = 5
    cfg.TRAINER.IVLP.PRIOR_FUSION_LAMBDA_TEXT = 1.0
    cfg.TRAINER.IVLP.PRIOR_FUSION_LAMBDA_VISION = 0.75
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
...
def setup_cfg(args):
    ...
    # if cfg.DATASET.NAME== "OxfordPets":
    #     cfg.OPTIM.MAX_EPOCH = 100

    # if cfg.DATASET.NAME== "DescribableTextures" or cfg.DATASET.NAME == "Caltech101":
    ...
    #     cfg.OPTIM.MAX_EPOCH = 10
    #     cfg.OPTIM.RHO = 0.05
    #     cfg.TRAINER.IVLP.FLEX_PROMPT_DEPTH_VISION = 6
    #     cfg.TRAINER.IVLP.FLEX_PROMPT_DEPTH_TEXT = 6
    #     cfg.TRAINER.IVLP.PRIOR_FUSION_LAYER_TEXT = 7
    #     cfg.TRAINER.IVLP.PRIOR_FUSION_LAYER_VISION = 7
    ...
    # if cfg.DATASET.NAME== "FGVCAircraft" or cfg.DATASET.NAME == "StanfordCars":
    #     cfg.OPTIM.MAX_EPOCH = 50
    #     cfg.OPTIM.RHO = 0.1

    # if cfg.DATASET.NAME== "SUN397":
    #     cfg.OPTIM.MAX_EPOCH = 30
    #     cfg.OPTIM.RHO = 0.2
    ...
    # if cfg.DATASET.NAME== "OxfordFlowers":
    #     cfg.OPTIM.MAX_EPOCH = 10
    #     cfg.OPTIM.RHO = 0.1
